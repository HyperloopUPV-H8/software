...
import { HvscuStateIndicator } from 'components/HvscuStateIndicator/HvscuStateIndicator';
            ...
            <div className={styles.HVSCU}>
                <div className={styles.levitationUnitsWrapper}>
                    <div className={styles.levitationUnitsColumn}>  
                        <div className={styles.text}><span className={styles.subtitle}>IMD</span><HvscuStateIndicator measurementId={'HVSCU-Cabinet/imd_status'} icon={thunderIcon} /></div>
