...
import {
  emergencyStopOrders,
  getHardcodedOrders,
} from "../BatteriesPage/FixedOrders";
...
// H10: Joan Física @JFisica, Marc Sanchis @msanlli
// @JFisica: My first time doing frontend was 4 days ago so sorry for probably breaking everything for next year
// @msanlli: My first time doing frontend was 4 days ago so sorry for probably breaking everything for next year
