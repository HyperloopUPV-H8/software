...
function M$2(a2, b2, e2) {
  ...
  if (null != b2)
    for (d2 in void 0 !== b2.ref && (h2 = b2.ref), void 0 !== b2.key && (k2 = "" + b2.key), b2)
      J.call(b2, d2) && !L$2.hasOwnProperty(d2) && (c6[d2] = b2[d2]);
  ...
  return { $$typeof: l$5, type: a2, key: k2, ref: h2, props: c6, _owner: K$1.current };
}
function N$2(a2, b2) {
...
function R$2(a2, b2, e2, d2, c6) {
  ...
  if (h2)
    return h2 = a2, c6 = c6(h2), a2 = "" === d2 ? "." + Q$2(h2, 0) : d2, I$2(c6) ? (e2 = "", null != a2 && (e2 = a2.replace(P$2, "$&/") + "/"), R$2(c6, b2, e2, "", function(a3) {
      return a3;
    })) : null != c6 && (O$2(c6) && (c6 = N$2(c6, e2 + (!c6.key || h2 && h2.key === c6.key ? "" : ("" + c6.key).replace(P$2, "$&/") + "/") + a2)), b2.push(c6)), 1;
  h2 = 0;
  d2 = "" === d2 ? "." : d2 + ":";
  if (I$2(a2))
    for (var g2 = 0; g2 < a2.length; g2++) {
      k2 = a2[g2];
      var f2 = d2 + Q$2(k2, g2);
      h2 += R$2(k2, b2, e2, f2, c6);
    }
  else if (f2 = A$3(a2), "function" === typeof f2)
    for (a2 = f2.call(a2), g2 = 0; !(k2 = a2.next()).done; )
      k2 = k2.value, f2 = d2 + Q$2(k2, g2++), h2 += R$2(k2, b2, e2, f2, c6);
  else if ("object" === k2)
...
react_production_min.cloneElement = function(a2, b2, e2) {
  ...
  return { $$typeof: l$5, type: a2.type, key: c6, ref: k2, props: d2, _owner: h2 };
};
...
function q$5(c6, a2, g2) {
  ...
  return { $$typeof: k$4, type: c6, key: e2, ref: h2, props: d2, _owner: n$5.current };
}
...
function v$4(a2, b2, c6, d2, e2, f2, g2) {
...
function Ya(a2, b2) {
  var c6 = b2.checked;
  return A$2({}, b2, { defaultChecked: void 0, defaultValue: void 0, value: void 0, checked: null != c6 ? c6 : a2._wrapperState.initialChecked });
}
function Za(a2, b2) {
...
function Kb(a2, b2) {
  ...
  if (c6 && "function" !== typeof c6)
    throw Error(p$5(231, b2, typeof c6));
  return c6;
}
var Lb = false;
if (ia)
...
function dg(a2, b2, c6) {
  ...
  if (!d2)
    throw Error(p$5(169));
  c6 ? (a2 = bg(a2, b2, Xf), d2.__reactInternalMemoizedMergedChildContext = a2, E$1(Wf), E$1(H$1), G$1(H$1, a2)) : E$1(Wf);
  G$1(Wf, c6);
}
  ...
  if (I$1) {
    ...
    if (b2) {
      ...
      if (!Cg(a2, b2)) {
        ...
        var d2 = xg;
        b2 && Cg(a2, b2) ? Ag(d2, c6) : (a2.flags = a2.flags & -4097 | 2, I$1 = false, xg = a2);
      }
    } else {
      if (Dg(a2))
        throw Error(p$5(418));
...
function kh(a2, b2, c6, d2) {
  b2 = a2.memoizedState;
  c6 = c6(d2, b2);
  c6 = null === c6 || void 0 === c6 ? b2 : A$2({}, b2, c6);
  a2.memoizedState = c6;
...
var nh = { isMounted: function(a2) {
  ...
  a2 = a2._reactInternals;
  var c6 = L$1(), d2 = lh(a2), e2 = ch(c6, d2);
  e2.tag = 2;
...
function vh(a2) {
  ...
  function n2(e3, g3, h3, k3) {
    ...
    if (w2 === h3.length)
      return c6(e3, u2), I$1 && tg(e3, w2), l3;
    if (null === u2) {
      for (; w2 < h3.length; w2++)
...
function fi(a2) {
  ...
  var d2 = O$1, e2 = d2.baseQueue, f2 = c6.pending;
  if (null !== f2) {
    if (null !== e2) {
      var g2 = e2.next;
      e2.next = f2.next;
...
function ii(a2, b2) {
  var c6 = N$1, d2 = di(), e2 = b2(), f2 = !He(d2.memoizedState, e2);
...
function ni(a2, b2, c6) {
  ...
  b2 = N$1.updateQueue;
  null === b2 ? (b2 = { lastEffect: null, stores: null }, N$1.updateQueue = b2, b2.stores = [a2]) : (c6 = b2.stores, null === c6 ? b2.stores = [a2] : c6.push(a2));
}
...
function li(a2, b2, c6, d2) {
  ...
  b2 = N$1.updateQueue;
  null === b2 ? (b2 = { lastEffect: null, stores: null }, N$1.updateQueue = b2, b2.lastEffect = a2.next = a2) : (c6 = b2.lastEffect, null === c6 ? b2.lastEffect = a2.next = a2 : (d2 = c6.next, c6.next = a2, a2.next = d2, b2.lastEffect = a2));
  return a2;
}
function si() {
...
function Di(a2, b2, c6) {
  ...
  He(c6, b2) || (c6 = yc(), N$1.lanes |= c6, hh |= c6, a2.baseState = true);
  return b2;
}
function Ei(a2, b2) {
  var c6 = C;
...
function ri(a2, b2, c6) {
  ...
  if (Hi(a2))
    ...
    c6 = Yg(a2, b2, e2, d2);
    null !== c6 && (e2 = L$1(), mh(c6, a2, d2, e2), Ji(c6, b2, d2));
  }
}
function Hi(a2) {
  var b2 = a2.alternate;
...
function ej(a2, b2, c6) {
  ...
  if ("hidden" === d2.mode)
    if (0 === (b2.mode & 1))
      b2.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }, G$1(fj, gj), gj |= c6;
    else {
      if (0 === (c6 & 1073741824))
        return a2 = null !== f2 ? f2.baseLanes | c6 : c6, b2.lanes = b2.childLanes = 1073741824, b2.memoizedState = { baseLanes: a2, cachePool: null, transitions: null }, b2.updateQueue = null, G$1(fj, gj), gj |= a2, null;
    ...
    null !== f2 ? (d2 = f2.baseLanes | c6, b2.memoizedState = null) : d2 = c6, G$1(fj, gj), gj |= d2;
  Yi(a2, b2, e2, c6);
  return b2.child;
}
function hj(a2, b2) {
...
function ij(a2, b2, c6, d2, e2) {
  ...
  if (null === b2.stateNode)
    ...
    "object" === typeof l2 && null !== l2 ? l2 = Vg(l2) : (l2 = Zf(c6) ? Xf : H$1.current, l2 = Yf(b2, l2));
    ...
    r2 = g2.context;
    k2 = c6.contextType;
    "object" === typeof k2 && null !== k2 ? k2 = Vg(k2) : (k2 = Zf(c6) ? Xf : H$1.current, k2 = Yf(b2, k2));
  ...
  switch (b2.tag) {
    ...
    case 19:
      ...
      if (null === g2)
        ...
        if (!d2)
          if (a2 = Mh(g2), null !== a2) {
            if (b2.flags |= 128, d2 = true, c6 = a2.updateQueue, null !== c6 && (b2.updateQueue = c6, b2.flags |= 4), Ej(f2, true), null === f2.tail && "hidden" === f2.tailMode && !g2.alternate && !I$1)
              return S$1(b2), null;
          } else
            2 * B$1() - f2.renderingStartTime > Hj && 1073741824 !== c6 && (b2.flags |= 128, d2 = true, Ej(f2, false), b2.lanes = 4194304);
        f2.isBackwards ? (g2.sibling = b2.child, b2.child = g2) : (c6 = f2.last, null !== c6 ? c6.sibling = g2 : b2.child = g2, f2.last = g2);
      }
      if (null !== f2.tail)
        return b2 = f2.tail, f2.rendering = b2, f2.tail = b2.sibling, f2.renderingStartTime = B$1(), b2.sibling = null, c6 = M$1.current, G$1(M$1, d2 ? c6 & 1 | 2 : c6 & 1), b2;
      S$1(b2);
      return null;
    case 22:
    case 23:
...
function ak(a2, b2, c6) {
  ...
  switch (c6.tag) {
    ...
    case 6:
      ...
      X$1 = d2;
      Yj = e2;
      null !== X$1 && (Yj ? (a2 = X$1, c6 = c6.stateNode, 8 === a2.nodeType ? a2.parentNode.removeChild(c6) : a2.removeChild(c6)) : X$1.removeChild(c6.stateNode));
      break;
    case 18:
      null !== X$1 && (Yj ? (a2 = X$1, c6 = c6.stateNode, 8 === a2.nodeType ? Kf(a2.parentNode, c6) : 1 === a2.nodeType && Kf(a2, c6), bd(a2)) : Kf(X$1, c6.stateNode));
      break;
    case 4:
      d2 = X$1;
      e2 = Yj;
      X$1 = c6.stateNode.containerInfo;
      Yj = true;
      Zj(a2, b2, c6);
      X$1 = d2;
      Yj = e2;
    ...
    case 14:
    case 15:
      if (!U$1 && (d2 = c6.updateQueue, null !== d2 && (d2 = d2.lastEffect, null !== d2))) {
        e2 = d2 = d2.next;
        do {
      ...
      break;
    case 1:
      if (!U$1 && (Mj(c6, b2), d2 = c6.stateNode, "function" === typeof d2.componentWillUnmount))
        try {
    ...
    case 21:
      ...
      break;
    case 22:
      c6.mode & 1 ? (U$1 = (d2 = U$1) || null !== c6.memoizedState, Zj(a2, b2, c6), U$1 = d2) : Zj(a2, b2, c6);
      break;
    default:
      Zj(a2, b2, c6);
  }
...
function mh(a2, b2, c6, d2) {
  ...
  Ac(a2, c6, d2);
  if (0 === (K & 2) || a2 !== R$1)
    a2 === R$1 && (0 === (K & 2) && (rk |= c6), 4 === T && Dk(a2, Z$1)), Ek(a2, d2), 1 === c6 && 0 === K && 0 === (b2.mode & 1) && (Hj = B$1() + 500, fg && jg());
}
function Ek(a2, b2) {
...
function Hk(a2, b2) {
  ...
  if (0 !== b2) {
    ...
    if (1 === b2)
      throw c6 = qk, Lk(a2, 0), Dk(a2, d2), Ek(a2, B$1()), c6;
    if (6 === b2)
      Dk(a2, d2);
    else {
...
function Fk(a2) {
  ...
  if (1 === c6)
    throw c6 = qk, Lk(a2, 0), Dk(a2, b2), Ek(a2, B$1()), c6;
  if (6 === c6)
    throw Error(p$5(345));
...
function Ui(a2, b2, c6) {
  ...
  R$1 === a2 && (Z$1 & c6) === c6 && (4 === T || 3 === T && (Z$1 & 130023424) === Z$1 && 500 > B$1() - gk ? Lk(a2, 0) : sk |= c6);
  Ek(a2, b2);
}
function Zk(a2, b2) {
...
Wk = function(a2, b2, c6) {
  ...
  switch (b2.tag) {
    case 2:
      ...
      var f2 = bi();
      b2.flags |= 1;
      "object" === typeof e2 && null !== e2 && "function" === typeof e2.render && void 0 === e2.$$typeof ? (b2.tag = 1, b2.memoizedState = null, b2.updateQueue = null, Zf(d2) ? (f2 = true, cg(b2)) : f2 = false, b2.memoizedState = null !== e2.state && void 0 !== e2.state ? e2.state : null, ah(b2), e2.updater = nh, b2.stateNode = e2, e2._reactInternals = b2, rh(b2, d2, a2, c6), b2 = kj(null, b2, d2, true, f2, c6)) : (b2.tag = 0, I$1 && f2 && vg(b2), Yi(null, b2, e2, c6), b2 = b2.child);
      return b2;
    case 16:
      d2 = b2.elementType;
      a: {
      ...
      a: {
        ...
        if (f2.isDehydrated)
          if (f2 = { element: d2, isDehydrated: false, cache: g2.cache, pendingSuspenseBoundaries: g2.pendingSuspenseBoundaries, transitions: g2.transitions }, b2.updateQueue.baseState = f2, b2.memoizedState = f2, b2.flags & 256) {
            ...
            for (yg = Lf(b2.stateNode.containerInfo.firstChild), xg = b2, I$1 = true, zg = null, c6 = Ch(b2, null, d2, c6), b2.child = c6; c6; )
  ...
  switch (a2.tag) {
    case 3:
      ...
      if (b2.current.memoizedState.isDehydrated) {
        ...
        0 !== c6 && (Cc(b2, c6 | 1), Ek(b2, B$1()), 0 === (K & 6) && (Hj = B$1() + 500, jg()));
      }
      break;
    case 13:
      Sk(function() {
...
var __defNormalProp$1 = function(obj, key, value2) {
  return key in obj ? __defProp$1(obj, key, { enumerable: true, configurable: true, writable: true, value: value2 }) : obj[key] = value2;
};
  ...
  function createAsyncThunk2(typePrefix, payloadCreator, options) {
    ...
    function actionCreator(arg) {
      return function(dispatch, getState2, extra) {
        var requestId = (options == null ? void 0 : options.idGenerator) ? options.idGenerator(arg) : nanoid$2();
  ...
  exchange(topic, req, id2, cb2) {
    ...
    const resCallback = (value2) => {
      cb2(value2, () => {
        ...
        if (callbacks2) {
          this.topicToSuscriptions.set(topic, callbacks2.filter((element) => element.id != id2));
        }
      });
    };
    const callbacks = this.topicToSuscriptions.get(topic);
    if (callbacks) {
      this.topicToSuscriptions.set(topic, [
        ...callbacks,
        { id: id2, cb: resCallback }
      ]);
    } else {
      this.topicToSuscriptions.set(topic, [{ id: id2, cb: resCallback }]);
    }
  }
}
...
function reducer(state2, action) {
  switch (action.type) {
    case "add_pair":
      return [...state2, { id: nanoid$2(), pair: [null, null] }];
    case "update_pair":
...
const ExpandablePairs = ({ leftColumnName, rightColumnName, value: value2, onChange }) => {
  const [items2, dispatch] = reactExports.useReducer(reducer, value2, (value22) => value22.map((pair2) => ({ id: nanoid$2(), pair: pair2 })));
  reactExports.useEffect(() => {
...
function getNumericValidator(type, range) {
  return (v2) => {
    ...
    let result = true;
    result && (result = isNumberValid(v2, type));
    result && (result = range[0] ? range[0] <= v2 : result);
    result && (result = range[1] ? range[1] >= v2 : result);
    return result;
  };
}
...
function isNumberValid(value2, numberType) {
  if (isUnsignedIntegerType(numberType)) {
    return value2 % 1 == 0 && checkUnsignedIntegerOverflow(value2, getBits(numberType));
  } else if (isSignedIntegerType(numberType)) {
    return value2 % 1 == 0 && checkSignedIntegerOverflow(value2, getBits(numberType));
  } else {
    return checkFloatOverflow(value2);
  }
}
function checkUnsignedIntegerOverflow(value2, bits) {
  return value2 >= 0 && value2 < 1 << bits;
}
function checkSignedIntegerOverflow(value2, bits) {
  return value2 >= -1 << bits - 1 && value2 < 1 << bits - 1;
}
function checkFloatOverflow(value2) {
...
function selectLcuMeasurements(measurements) {
  return {
    ...
    reference_current_1: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_reference_current_1"),
    reference_current_2: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_reference_current_2"),
    reference_current_3: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_reference_current_3"),
    reference_current_4: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_reference_current_4"),
    slave_reference_current_5: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_slave_reference_current_5"),
    slave_reference_current_6: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_slave_reference_current_6"),
    slave_reference_current_7: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_slave_reference_current_7"),
    slave_reference_current_8: getMeasurementFallback(measurements, "LCU_MASTER/lcu_master_slave_reference_current_8"),
...
const SidebarItem = ({ item, isActive }) => {
  return /* @__PURE__ */ jsx(
    ...
    {
      to: item.path,
      className: `${styles$Q.link} ${isActive ? styles$Q.active : ""}`,
      children: /* @__PURE__ */ jsxs("div", { className: styles$Q.iconWrapper, children: [
        " ",
        item.icon
      ] })
    }
...
const Sidebar = ({ items: items2 }) => {
  ...
  return /* @__PURE__ */ jsxs("nav", { className: styles$R.sidebarWrapper, children: [
    /* @__PURE__ */ jsx(Link, { to: "/", children: /* @__PURE__ */ jsx(SvgTeamLogo, { className: styles$R.logo }) }),
    /* @__PURE__ */ jsx("div", { className: styles$R.separator }),
    /* @__PURE__ */ jsx("div", { className: styles$R.items, children: items2.map((item) => {
      return /* @__PURE__ */ jsx(
        SidebarItem,
        {
          item,
...
const App = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: styles$S.appWrapper, children: /* @__PURE__ */ jsx(
    Loader,
    {
      promises: [
        createWsHandler(
...
const Window = ({ title: title2, height, children }) => {
  return /* @__PURE__ */ jsxs(
    "article",
    {
      className: styles$N.window,
      style: {
        height: height == "fit" ? "fit-content" : height == "fill" ? "100%" : void 0
      },
      children: [
        /* @__PURE__ */ jsx("header", { className: styles$N.header, children: title2 }),
        /* @__PURE__ */ jsx(
          "div",
          {
...
const ValueData = reactExports.memo(({ measurement }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$L.valueDataWrapper, children: [
    /* @__PURE__ */ jsx("span", { className: styles$L.name, children: measurement.name }),
    isNumeric && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("span", { className: styles$L.units, children: measurement.units })
    ] }),
...
const IconTag = ({ icon: icon2, measurement }) => {
  return /* @__PURE__ */ jsxs("article", { className: styles$M.iconTagWrapper, children: [
    icon2,
...
const Separator = () => {
  return /* @__PURE__ */ jsx("div", { className: styles$J.separatorWrapper, children: /* @__PURE__ */ jsx("div", { className: styles$J.line }) });
};
const MultipleTags = ({ tags: tags2, className = "" }) => {
  return /* @__PURE__ */ jsx("article", { className: `${styles$K.multipleTagsWrapper} ${className}`, children: tags2.map((tag, index2, arr) => {
...
const RangeBar = ({ type, value: value2, min, max }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `${type == "temp" ? styles$E.tempWrapper : ""}`, children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        className: styles$E.rangeBarWrapper,
        style: {
...
const BoolBar = ({ isOn }) => {
  return /* @__PURE__ */ jsx(
    "div",
    {
      className: `${styles$D.boolBar} ${isOn ? styles$D.on : styles$D.off}`
    }
  );
};
const Bar = (props) => {
...
const StateOverlay = ({ state: state2, children }) => {
  return /* @__PURE__ */ jsxs("div", { className: styles$C.stateOverlay, children: [
    /* @__PURE__ */ jsx(
      "div",
      {
...
const BarTag = ({
  ...
  return /* @__PURE__ */ jsx(StateOverlay, { state: getState(measurement), children: /* @__PURE__ */ jsxs(
    "article",
    {
      className: `${styles$F.barTagWrapper} ${showWrapper ? styles$F.tagWrapper : ""}`,
      children: [
...
const ImageTag = ({
  ...
  return /* @__PURE__ */ jsxs("article", { className: `${styles$G.imageTagWrapper} tagWrapper`, children: [
    /* @__PURE__ */ jsx(
      BarTag,
      {
        barType: "range",
...
const AirgapRow = ({ hems1, ems1, ems2, hems2 }) => {
  return /* @__PURE__ */ jsxs("div", { className: styles$H.airgapRowWrapper, children: [
    /* @__PURE__ */ jsx(
      ImageTag,
      {
        imageUrl: emsUrl,
...
const Airgaps = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `${styles$I.airgapsWrapper} ${className}`, children: [
    /* @__PURE__ */ jsx(
      AirgapRow,
      {
        ems1: airgap_1,
...
const CoilInfoLabel = ({ measurement }) => {
  return /* @__PURE__ */ jsxs("div", { className: styles$y.coilInfoLabelWrapper, children: [
    /* @__PURE__ */ jsx("span", { className: styles$y.name, children: measurement.name }),
    /* @__PURE__ */ jsx("span", { className: styles$y.value, children: measurement.value.average.toFixed(2) + " " + measurement.units })
  ] });
};
const CoilInfoLabels = ({ measurements }) => {
  return /* @__PURE__ */ jsx("div", { className: styles$z.coilInfoLabelsWrapper, children: measurements.map((measurement) => {
    return /* @__PURE__ */ jsx(
      CoilInfoLabel,
      {
        measurement
...
const CoilInfo = ({ coilData }) => {
  return /* @__PURE__ */ jsxs("article", { className: styles$A.coilInfoWrapper, children: [
    /* @__PURE__ */ jsx(
      CoilInfoLabels,
      {
        measurements: [
...
const CoilsInfo = ({ coilsData, className = "" }) => {
  return /* @__PURE__ */ jsx("div", { className: `${styles$B.coilsInfoWrapper} ${className}`, children: coilsData.map((data, index2) => {
    return /* @__PURE__ */ jsx(
      CoilInfo,
      {
        coilData: data
...
const LCU = (props) => {
  return /* @__PURE__ */ jsx(Window, { title: "LCU", children: /* @__PURE__ */ jsxs("section", { className: styles$O.levitationSectionWrapper, children: [
    /* @__PURE__ */ jsx(
      Rotations,
      {
        className: styles$O.rotations,
        rot1: props.rot_x,
        rot2: props.rot_y,
        rot3: props.rot_z
      }
    ),
    /* @__PURE__ */ jsxs("div", { className: styles$O.positions, children: [
      /* @__PURE__ */ jsx(
        BarTag,
        {
          barType: "range",
...
const pcuSectionWrapper = "_pcuSectionWrapper_mrfew_1";
const styles$x = {
  pcuSectionWrapper
};
    ...
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(
          Arc,
          {
            className: styles$t.backgroundArc,
            sweep,
            radius,
            strokeWidth,
            percentage: 100
...
const TextData = reactExports.memo(({ name: name2, value: value2, units: units2 }) => {
  return /* @__PURE__ */ jsxs("div", { className: styles$s.textData, children: [
    /* @__PURE__ */ jsx("div", { className: styles$s.name, children: name2 }),
    /* @__PURE__ */ jsx("div", { className: styles$s.value, children: value2.toFixed(2) }),
    /* @__PURE__ */ jsx("div", { className: styles$s.units, children: units2 })
  ] });
});
const GaugeTag = ({
  measurement,
  ...
  return /* @__PURE__ */ jsxs("article", { className: `${styles$v.gaugeTagWrapper} ${className}`, children: [
    /* @__PURE__ */ jsx(
      Gauge,
      {
        className: styles$v.gauge,
        sweep: 250,
        strokeWidth,
...
const DirectionTag = ({ axis: axis2, value: value2, units: units2 }) => {
  return /* @__PURE__ */ jsxs("div", { className: styles$r.directionTagWrapper, children: [
    /* @__PURE__ */ jsx("span", { className: styles$r.axis, children: axis2 }),
    /* @__PURE__ */ jsxs("div", { className: styles$r.valueWrapper, children: [
      /* @__PURE__ */ jsx("span", { className: styles$r.value, children: value2.toFixed(2) }),
      /* @__PURE__ */ jsx("span", { className: styles$r.units, children: units2 })
    ] })
  ] });
};
const VectorGauge = ({ x: x2, y: y2, z: z2 }) => {
  return /* @__PURE__ */ jsxs("article", { className: styles$w.vectorGauge, children: [
    /* @__PURE__ */ jsx(
      GaugeTag,
      {
        measurement: x2,
        ...
        max: 100,
        strokeWidth: 145,
        className: styles$w.velGauge
      }
    ),
    /* @__PURE__ */ jsxs("div", { className: styles$w.directions, children: [
      /* @__PURE__ */ jsx(
        DirectionTag,
        {
          axis: "x",
...
const MotorInfo = ({ title: title2, motorCurrentU }) => {
  return /* @__PURE__ */ jsx("div", { className: styles$q.motorInfoWrapper, children: /* @__PURE__ */ jsx(
    ColorfulChart,
    {
      className: styles$q.chart,
      title: title2,
      length: 100,
      items: [
        {
          ...
          color: "red",
          getUpdate: () => {
            const measurement = store.getState().measurements.measurements[motorCurrentU.id];
            if (!measurement) {
              return 0;
            }
...
const TempTag = ({ meas, icon: icon2 }) => {
  return /* @__PURE__ */ jsx(StateOverlay, { state: getState(meas), children: /* @__PURE__ */ jsxs("div", { className: styles$p.tempTag, children: [
    /* @__PURE__ */ jsx("div", { className: styles$p.title, children: meas.name }),
    /* @__PURE__ */ jsx("div", { className: styles$p.icon, children: icon2 }),
    /* @__PURE__ */ jsx("div", { className: styles$p.value, children: `${meas.value.last.toFixed(2)} ${meas.units}` })
  ] }) });
};
...
const PCU = (props) => {
  return /* @__PURE__ */ jsx(Window, { title: "PCU", children: /* @__PURE__ */ jsxs("section", { className: styles$x.pcuSectionWrapper, children: [
    /* @__PURE__ */ jsx(
      VectorGauge,
      {
        x: props.velocity,
...
const BMSL = (props) => {
  return /* @__PURE__ */ jsx(Window, { title: "BMSL", children: /* @__PURE__ */ jsxs("div", { className: styles$o.bmsl, children: [
...
const BatteryInfo = (props) => {
  return /* @__PURE__ */ jsxs("div", { className: styles$n.batteryInfo, children: [
    /* @__PURE__ */ jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: styles$n.content, children: [
      /* @__PURE__ */ jsx("span", { className: styles$n.title, children: props.title }),
      /* @__PURE__ */ jsxs("div", { className: styles$n.tags, children: [
...
const GeneralInfo = (props) => {
  return /* @__PURE__ */ jsxs("div", { className: styles$m.generalInfo, children: [
    /* @__PURE__ */ jsx(
      BarTag,
      {
        barType: "range",
...
const OBCCU = (props) => {
  return /* @__PURE__ */ jsx(Window, { title: "OBCCU", children: /* @__PURE__ */ jsxs("div", { className: styles$l.obccu, children: [
    /* @__PURE__ */ jsx(
      GeneralInfo,
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: styles$l.batteries, children: [
      /* @__PURE__ */ jsx(
        BatteryInfo,
        {
          title: "Battery 1",
...
const VCU = (props) => {
  return /* @__PURE__ */ jsx(Window, { title: "VCU", children: /* @__PURE__ */ jsxs("div", { className: styles$k.vcu, children: [
    /* @__PURE__ */ jsx(
      ValueDataTag,
      {
        measurement: {
    ...
    /* @__PURE__ */ jsx(ValueDataTag, { measurement: props.reed_state }),
    /* @__PURE__ */ jsx(
      BarTag,
      {
        barType: "range",
...
const BoardsPage = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$P.boardsPage, children: [
    /* @__PURE__ */ jsx(OBCCU, { ...selectObccuMeasurements(measurements) }),
    /* @__PURE__ */ jsxs("div", { className: styles$P.column, children: [
      /* @__PURE__ */ jsx(VCU, { ...selectVcuMeasurements(measurements) }),
      /* @__PURE__ */ jsx(PCU, { ...selectPcuMeasurements(measurements) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: styles$P.gridColumn, children: [
...
const controlPage = "_controlPage_1q6ih_1";
const styles$j = {
  controlPage
};
const emergencyOrdersWrapper = "_emergencyOrdersWrapper_1vqjt_1";
const icon = "_icon_1vqjt_10";
...
const EmergencyButton = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: `${styles$h.emergencyButtonWrapper} ${className}`,
      onClick: onTrigger,
      children: [
        icon2,
        /* @__PURE__ */ jsx("span", { className: styles$h.label, children: label2 })
      ]
    }
  );
};
...
const EmergencyOrders = ({
  ...
  const StyledStopIcon = /* @__PURE__ */ jsx(SvgStopIcon, { className: styles$i.icon });
  ...
  const StyledBrakeIcon = /* @__PURE__ */ jsx(SvgBrake, { className: styles$i.icon });
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$i.emergencyOrdersWrapper, children: [
    /* @__PURE__ */ jsx(
      EmergencyButton,
      {
        label: "STOP",
        icon: StyledStopIcon,
        className: styles$i.stopBtn,
        targetKey: "s",
        onTrigger: stop2
      }
    ),
    ...
    /* @__PURE__ */ jsx(
      EmergencyButton,
      {
        ...
        className: styles$i.contactorBtn,
        targetKey: "o",
...
const RestartVcuOrder = {
  id: 209,
  fields: {}
};
const RestartPcuOrder = {
  id: 602,
  fields: {}
};
const RestartObccuOrder = {
  id: 906,
  fields: {}
};
const RestartLcuMasterOrder = {
  id: 236,
  fields: {}
};
const RestartBmslOrder = {
  id: 804,
  fields: {}
};
const RestartOrders = [
...
const ControlPage = () => {
  const sendOrder = useSendOrder();
  return /* @__PURE__ */ jsxs("div", { className: styles$j.controlPage, children: [
    /* @__PURE__ */ jsx(
      Window,
      {
        title: "Orders",
        height: "fill",
        children: /* @__PURE__ */ jsx(Orders, { orders: hardcodedOrders })
      }
    ),
    /* @__PURE__ */ jsx(
      Window,
