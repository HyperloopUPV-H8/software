...
// Final "check" page layout: sw logo up top, check mark below it, shifted
// down from strict vertical center to sit closer to the sw logo as a group.
export const CHECK_PAGE_SW_LOGO_WIDTH = 40;
export const CHECK_PAGE_SW_LOGO_TOP = 45;
export const CHECK_LOGO_SIZE = 45;
export const CHECK_LOGO_Y_OFFSET = 20;
